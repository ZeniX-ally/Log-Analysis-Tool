...
# ==========================================
# [修改对比批注]
# 原内容: SERVER_IP = "10.222.126.115"
# 修改逻辑: 统一指向 Ubuntu 服务器静态局域网 IP。
SERVER_IP = "192.168.x.x"  # <--- 请根据实际 Ubuntu IP 替换 [修改点]
    ...
    while True:
        try:
            ...
            for file_path in xml_files:
                ...
                # [中枢新增批注 3: O(1) 账本防重拦截，文件若已在内存集合中，直接跳过]
                ...
                try:
                    ...
                    if resp_data.get("ok"):
                        ...
                        # [中枢新增批注 4: 上传成功后，同时更新内存与追加 txt 账本文件]
