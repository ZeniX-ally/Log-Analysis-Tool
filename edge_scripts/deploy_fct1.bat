@echo off
chcp 65001 >nul
title FCT1 边缘代理一键部署 - 172.28.55.11
echo ================================================================
echo    PEU FCT Edge Agent - 一键部署脚本
echo    机台: FCT1 ^| IP: 172.28.55.11 ^| ID: PEU_G49_FCT1_01
echo ================================================================
echo.
...
set "MACHINE_ID=PEU_G49_FCT1_01"
set "MACHINE_IP=172.28.55.11"
set "LOG_DIR=D:\Results"
set "SERVER_IP=172.28.55.66"
set "SERVER_PORT=59488"
set "TASK_NAME=FCTAgent_FCT1"
